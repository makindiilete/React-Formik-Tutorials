...
const validationSchema = Yup.object({
  ...
  password: Yup.string().required("Password cannot be empty").matches(/^(?=(.*[0-9]))(?=.*[\!@#$%^&*()\\[\]{}\-_+=~`|:;"'<>,./?])(?=.*[a-z])(?=(.*[A-Z]))(?=(.*)).{10,}$/, "Must be up to 10 characters, special characters, upper and lower case"),
  address: Yup.string().required("Address Cannot Be Empty"),
  radioOptions: Yup.string().required("Option Is Required"),
  selectDropDown: Yup.string().required("Select Dropdown Is Required"),
});
      ...
      {(formik) => {
        ...
        return (
          <Form>
            ...
            {/*Using the render function to create our AntDesign field */}
            <div className="form-group">
              <label htmlFor="password">Ant Design Icon Field</label>
              <Field name="password">
                {(props) => {
                  const { field, form, meta } = props;
                  return (
            ...
            {/*Using the render function to create our radio options*/}
            <div className="form-group">
              <label htmlFor="radioOptions">Radio Options</label>
              ...
              <ErrorMessage name="radioOptions" component={TextError} />
            </div>
            {/*Using the render function to create our select dropdown options*/}
            <div className="form-group">
              ...
              <ErrorMessage name="selectDropDown" component={TextError} />
            </div>
            {/*Nested object*/}
            <div className="form-group">
